...
settings = {
    ...
    "Respontag":"(9)โดเรมีบอท(9)   ",
    "ResponPM":"(9)โดเรมีบอท(9)   ",
    "message":" (9)โดเรมีบอท(9) ",
    "comment":"(9)โดเรมีบอท(9)   ",
    "Wc":" (9)โดเรมีบอท(9)  ",
    "bye":"(9)โดเรมีบอท(9)   ",
    "add":"(9)โดเรมีบอท(9)   ",
    "kick":" (9)โดเรมีบอท(9)   ",
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『(9)โดเรมีบอท(9)』")
...
#-------------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"❂•สักครู่ระบบ(9)โดเรมีบอท(9)กำลังประมวลผล•❂\n 「」™")
                            ...
                            dataProfile = [
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                               "type": "image",
                                                "url": "https://obs-us.line-apps.com/myhome/h/download.nhn?tid=612w&{}".format(str(msg.contentMetadata["mediaOid"])),
                                                "size": "full"
                                            },
                                            {
                                                "type": "text",
                                ...
                                },
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": "https://images.app.goo.gl/MhojCeLARirai3tv7,
                                                "size": "full"
                                            },
                                            {
                                                "type": "text",
                                                "text": "•(9)โดเรมีบอท(9)ประกาศเฟก5G ",
                                                "size": "xxl",
                                                "weight": "bold",
                                                "align": "center",
                                                "color": s
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                         ...
                                         #   {
                                          ...
                                          #  {
                                          #      "type": "text",
                                          #      "text": "สนใจ ติดต่อได้ที่ปุ่มเลยค้ะ >_<",
                                          #      "color": "#B5B5B5",
                                          #      "size": "xs"
                                          #  },
                                            {
...
#==============================================================================#                    
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         settings["add"] = spl
                         line.sendMessage(msg.to, "『(9)โดเรมีบอท(9)』\nตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว\n\n[ {} ]".format(str(spl)))
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『(9)โดเรมีบอท(9)』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『(9)โดเรมีบอท(9)』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                ...
                if msg.contentType == 0 and sender not in lineMID and msg.toType == 2:
                    if "MENTION" in msg.contentMetadata.keys() != None:
        	             if settings['kickMention'] == True:
        		             ...
        		             balas = ["เนื่องจากตอนนี้(9)โดเรมีบอท(9)เปิดระบบเตะคนแทคไว้ " + "\n👉" + cName + "\n🙏ต้องขออภัยด้วยจริงๆ🙏Bye!!!"]
